...
phases: []
phases_conclusion: ''
banner_title: Improvements to the Decidim core
banner_subtitle: Around 20 new modules and integrations
banner: Helsinki has made various improvements to the Decidim core as well as **built around 20 modules and integrations to support the local needs and to improve the process for various stakeholders involved in it**. We have also greatly invested in the local redesign of the platform to improve the end-user experience and simplify the platform for all types of citizens through interviews, prototyping, user testing and accessibility evaluation.
optional_section_1_title: ''
optional_section_1: ''
optional_section_2_title: ''
optional_section_2: ''
optional_section_3_title: ''
optional_section_3: ''
testimonial_link: ''
