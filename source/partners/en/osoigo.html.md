...
url: osoigonext.com
image: /uploads/osoigo-logo.svg
joined_at: 2025.07.24
type:
  - Installation & Development
  - Participation Design
region: Spain
type_of_service_provider: Private civic-tech company (software + consulting)
most_relevant_experiences: |-
  - [**RTVE – Citizen Participation Portal**](https://www.osoigonext.com/blog/aapp/rtve-abre-la-participacion-ciudadana-una-nueva-etapa-de-interaccion-publica osoigonext.com+1)

  Osoigo Next developed the new citizen-participation portal for RTVE (RTVE Play), enabling a unified platform for polls, live voting, proposal collection, forums, video chat-encounters, and result analytics. 
   Key contributions:
  ...
  - Surveyed 10,000+ young people on housing situation & youth emancipation in Euskadi. 
  - Carried out hybrid participation including online questionnaire + in-person workshops, culminating in a report delivered to institutional stakeholders.
  - Osoigo Next co-led the methodological design and the digital infrastructure of the platform.
email_address: xabi@osoigo.com
---
