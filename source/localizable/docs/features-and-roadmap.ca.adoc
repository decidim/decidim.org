...
* Una vegada creada, la iniciativa passa a una fase de moderació i validació tècnica, on personal de l’Ajuntament pot realitzar diferents accions (aprovar-la, rebutjar-la o suggerir modificacions). Si s'aprova, es podrà començar a recollir els suports necessaris.
