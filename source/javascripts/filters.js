...
const genericFilter = () => {
  ...
  const cssClasses = {
    pageActive: "w-9 h-9 rounded-full bg-red-100 text-red-900 font-semibold text-sm flex items-center justify-center",
    pageInactive: "w-9 h-9 rounded-full text-red-900 font-medium text-sm flex items-center justify-center hover:bg-gray-100 transition-colors",
    prev: "flex items-center gap-2 px-5 py-2 rounded-lg border border-red-400 text-red-900 font-medium text-sm hover:bg-red-50 transition-colors mr-3",
    next: "flex items-center gap-2 px-5 py-2 rounded-lg border border-red-400 text-red-900 font-medium text-sm hover:bg-red-50 transition-colors ml-3",
    ...
    checkbox: "rounded border-gray-300 text-red-900 focus:ring-red-400 w-4 h-4 cursor-pointer",
