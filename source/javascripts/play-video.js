function playVideo(){
  var videoWrapper = document.querySelector("[data-video-wrapper]"),
      videoIframe = document.querySelector("[data-video-wrapper] iframe"),
  ...
  document.querySelector("[data-playvideo-button]").addEventListener("click", showVideo);
  document.querySelector("[data-closevideo]").addEventListener("click", hideVideo);
  document.querySelector("[data-video-wrapper]").addEventListener("click", hideVideo);
}
